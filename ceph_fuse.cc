...
int main(int argc, const char **argv, const char *envp[]) {
  ...
  // args is full of arguments from call of argv
  env_to_vec(args);

  // initialize a vector with the string "--pid-file="
  ...
  // parse all arguments step by step, for example, is there the "-h"? yes? print hint
